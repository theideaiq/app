...
/**
 * Sanitizes a JSON object for safe injection into a <script> tag.
 * escapes <, >, and other characters that could break out of the script context.
 *
 * @param data - The JSON object to sanitize.
