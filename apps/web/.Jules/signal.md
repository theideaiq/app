...
## 2024-05-25 - Product Structured Data
**Learning:** Product pages were missing Schema.org `Product` structured data, preventing Rich Snippets (price, availability, ratings) in search results.
**Action:** When adding new entity pages (e.g., Events, Articles), always create a corresponding JSON-LD component (like `ProductJsonLd`) and integrate it to ensure entity understanding by search engines.
