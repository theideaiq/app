...
const scenarios = [
  {
    ...
    message:
      'A glitch in the matrix has occurred. This page does not exist in this simulation.',
  ...
  },
  {
    ...
    title: 'GAME OVER',
    message:
      "The princess is in another castle. You've ventured into an unmapped level.",
    button: 'Respawn (Go Home)',
    accent:
      'bg-yellow-400 text-indigo-900 hover:bg-yellow-300 border-transparent',
  },
  {
    id: 'spooky',
    ...
    message:
      "There's nothing here but digital cobwebs and lost packets. Turn back before it's too late.",
  ...
  },
  {
    ...
    message:
      'Our developer went to get coffee and forgot to build this page. It happens.',
    ...
    >
      <AnimatePresence mode="wait">
        ...
        >
          ...
          <p
            className="text-xl mb-12 opacity-80 font-medium leading-relaxed"
            suppressHydrationWarning
          >
            {scenario.message}
          </p>
